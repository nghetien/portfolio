...
import type { TPostFrontMatter, TPostOgImage, TTableOfContents } from '@/types';
...
function Post({
  ...
  // get og image urls
  const postOgImages = getPostOgImageUrl<TPostOgImage>({
  ...
  return (
    <>
      ...
      <WithTableOfContents tableOfContents={tableOfContents}>
        {children}
        <PostFooter redirect='blog' tags={tags} category={category} />
      </WithTableOfContents>
    </>
  );
}
