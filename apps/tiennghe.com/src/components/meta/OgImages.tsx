...
import type { TPageOgImage, TPostOgImage, TProjectOgImage } from '@/types';
...
type PostOgImageProps = (TPostOgImage & { company?: string }) | TProjectOgImage;
...
export function PostOgImage({
  ...
  return (
    <div style={styles.container}>
      ...
      {company && <div style={styles.description}>{company}</div>}

      <div style={styles.author}>
        <img
          width="48"
          height="48"
          src="https://avatars.githubusercontent.com/u/61019797?v=4&size=64"
          style={styles.authorAvatar}
        />
        <div style={styles.authorName}>nghetien</div>
    ...
    <div style={styles.container}>
      ...
      <div style={styles.author}>
        <img
          ...
          style={styles.authorAvatar}
        />
        <div style={styles.authorName}>tiennghe</div>
      </div>
      <div
        style={
          caption.toLowerCase() === 'work'
